...
public interface UsersRepositoryTest {
    ...
    default void testCreateUserFailsIfGroupDoesNotExist() {
        ...
        //No se está comprobando que ese grupo no existe
        UsersRepository repositoryLocal = getRepository();
        final var exception = assertThrows(RuntimeException.class, () ->
                repositoryLocal.createUser("a", "b", "a.b@example.com", "student", groupName)
        );
